...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      title: 'Anton — Software Engineer & AI Architect | zeroman',
      htmlAttrs: {
        lang: 'en'
      },
      meta: [
        ...
        { name: 'description', content: "Anton's Portfolio — Software Engineer & AI Architect. Specialized in custom web applications, multi-agent AI systems, and scalable backend architecture." },
