<template>
  ...
  <nav id="main-nav" role="navigation" aria-label="Main navigation">
    ...
    <div class="nav-split-left">
      <NuxtLink to="/" class="nav-link" exact-active-class="active" id="nav-home">
        {{ lang === 'id' ? 'Beranda' : 'Home' }}
      </NuxtLink>
      <NuxtLink to="/about" class="nav-link" exact-active-class="active" id="nav-about">
        {{ lang === 'id' ? 'Tentang' : 'About' }}
      </NuxtLink>
    </div>
    
    <div class="nav-split-right">
      <NuxtLink :to="projectsLink" class="nav-link" id="nav-projects">
        {{ lang === 'id' ? 'Proyek' : 'Projects' }}
      </NuxtLink>
      <NuxtLink to="/contact" class="nav-cta" exact-active-class="active" id="nav-contact">
      ...
      <NuxtLink to="/geo" class="nav-link-geo" exact-active-class="active" id="nav-geo">
